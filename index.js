...
app.use((req, res, next) => {
  res.header('Access-Control-Allow-Origin', 'https://adminstorenodejs.malcolmcordova.com, https://back-ecomm-mall.vercel.app/api/');
...
const options = {
  cors: {
      origin: '*, https://back-ecomm-mall.vercel.app/api/, https://adminstorenodejs.malcolmcordova.com',
  },
};
